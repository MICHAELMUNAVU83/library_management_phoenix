defmodule LibraryManagementWeb.BookControllerTest do
  use LibraryManagementWeb.ConnCase

  import LibraryManagement.BooksFixtures

  @create_attrs %{isbn: 42, publication_date: ~D[2023-05-21], title: "some title"}
